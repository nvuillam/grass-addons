...
max_seq1d=${max_line: -5:1}
if [ -z $max_seq1d ]; then max_seq1d=0; fi
max_seq2d=${max_line: -6:1}
if [ -z $max_seq2d ]; then max_seq2d=0; else max_seq1d=9; fi
max_seq3d=${max_line: -7:1}
if [ -z $max_seq3d ]; then max_seq3d=0; else
	max_seq2d=9
	max_seq1d=9
fi
max_seq4d=${max_line: -8:1}
if [ -z $max_seq4d ]; then max_seq4d=0; else
	max_seq3d=9
	max_seq2d=9
	max_seq1d=9
fi
