...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep -v 2isis | grep -v isis2 | grep 2); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep -v 2 | grep cnet); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep -v 2 | grep -v cnet | grep cal); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep q[vmnt]); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "                <separator />" >>$tbfile
for i in $(ls !(xml) | grep footprint); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "                <separator />" >>$tbfile
for i in $(ls !(xml) | grep jigsaw); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "                <separator />" >>$tbfile
for i in $(ls !(xml) | grep shadow); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep apollo); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep -v hist | grep -v clem | grep -v pho | grep -v spec | grep hi); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
...
echo "          <items>" >>$tbfile
for i in $(ls !(xml) | grep kaguya); do
	echo "            <menuitem>" >>$tbfile
	echo "              <label>$i</label>" >>$tbfile
	echo "              <command>$i</command>" >>$tbfile
